...
class AnalysisRepositoryTest {
  ...
  void setUp() {
    ...
    AnalysisReagent analysisReagent1 =
        AnalysisReagent.builder().analysis(analysis1).reagent(reagent1).quantity(10).build();
    analysisReagent1 = analysisReagentRepository.save(analysisReagent1);
    AnalysisReagent analysisReagent2 =
        AnalysisReagent.builder().analysis(analysis1).reagent(reagent2).quantity(5).build();
  ...
  public void AnalysisRepository_Save_ReturnAnalysis() {
    ...
    AnalysisReagent analysisReagent1 =
        AnalysisReagent.builder().analysis(analysis2).reagent(reagent1).quantity(2).build();
    analysisReagent1 = analysisReagentRepository.save(analysisReagent1);
    // Assert
