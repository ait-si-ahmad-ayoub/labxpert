...
class ReagentRepositoryTest {
  ...
  public void ReagentRepository_save_ReturnReagent() {
    ...
    assertEquals(
        reagent3.getReagentID(),
        reagentRepository.findById(reagent3.getReagentID()).get().getReagentID());
    assertEquals(
        reagent3.getReagentName(),
        reagentRepository.findById(reagent3.getReagentID()).get().getReagentName());
    assertEquals(
        reagent3.getReagentDescription(),
        reagentRepository.findById(reagent3.getReagentID()).get().getReagentDescription());
    assertEquals(
        reagent3.getQuantityInStock(),
        reagentRepository.findById(reagent3.getReagentID()).get().getQuantityInStock());
    assertEquals(
        reagent3.getExpirationDate(),
        reagentRepository.findById(reagent3.getReagentID()).get().getExpirationDate());
    assertEquals(
        reagent3.getSupplier(),
        reagentRepository.findById(reagent3.getReagentID()).get().getSupplier());
  }
  ...
  public void ReagentRepository_update_ReturnUpdatedReagent() {
    ...
    // assert
    assertEquals(
        reagent1.getReagentName(),
        reagentRepository.findById(reagent1.getReagentID()).get().getReagentName());
    assertEquals(
        reagent1.getReagentDescription(),
        reagentRepository.findById(reagent1.getReagentID()).get().getReagentDescription());
    assertEquals(
        reagent1.getQuantityInStock(),
        reagentRepository.findById(reagent1.getReagentID()).get().getQuantityInStock());
    assertEquals(
        reagent1.getExpirationDate(),
        reagentRepository.findById(reagent1.getReagentID()).get().getExpirationDate());
    assertEquals(
        reagent1.getSupplier(),
        reagentRepository.findById(reagent1.getReagentID()).get().getSupplier());
  }
